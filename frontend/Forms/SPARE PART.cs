    ...
    public partial class FSpare : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (listCB.Text != "" && qtyCB.Text != "" )
            {
                ...
                cmd = new SqlCommand("insert into Spare values(N'" + nameTB.Text + "',N'" + categoryCB.Text + "',N'" + value[0]+ "',N'" + value[1] + "',N'" + qty.ToString() + "',N'" + (int.Parse(value[1]) * qty).ToString() +"', N'" + dateTP.Text + "')", con);
                try
                {
                    con.Open();
                    cmd.ExecuteNonQuery();
